...
class VerificationTokenRepository extends ServiceEntityRepository
{
    ...
    public function save(VerificationToken $verificationToken, bool $flush = false): void
    {
    ...
    public function remove(VerificationToken $verificationToken, bool $flush = false): void
    {
