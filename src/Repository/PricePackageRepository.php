...
/**
 * @extends ServiceEntityRepository<PricePackage>
 *
...
class PricePackageRepository extends ServiceEntityRepository
{
    ...
    public function save(PricePackage $entity, bool $flush = false): void
    {
    ...
    public function remove(PricePackage $entity, bool $flush = false): void
    {
...
//    /**
//     * @return PricePackage[] Returns an array of PricePackage objects
//     */
...
//    public function findOneBySomeField($value): ?PricePackage
//    {
//        return $this->createQueryBuilder('p')
//            ->andWhere('p.exampleField = :val')
//            ->setParameter('val', $value)
