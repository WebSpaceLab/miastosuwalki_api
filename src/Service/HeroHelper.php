...
class HeroHelper
{
    public function __construct(private Packages $packages, private HeroRepository $heroRepository) {}

    public function getMonths() {
        // Wykonanie zapytania
        $dates = $this->heroRepository->getActiveMonths();
    ...
    public function getActive() {
        // Wykonanie zapytania
        $results =  $this->heroRepository->getActive();
