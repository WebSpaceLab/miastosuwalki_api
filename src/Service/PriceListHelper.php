...
{
    public function __construct(private Packages $packages, private PriceRepository $priceRepository) {}

    public function getMonths() {
        // Wykonanie zapytania
        $dates = $this->priceRepository->getActiveMonths();
    ...
    public function getActive() {
        // Wykonanie zapytania
        $results =  $this->priceRepository->getActive();
